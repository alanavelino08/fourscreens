  ...
  const fetchParts = async (page = 0) => {
    try {
      ...
      const response = await api.get(
        `/partnumbers/?page=${page + 1}&page_size=${pagination.rowsPerPage}`
      );
    ...
    <Container maxWidth="md">
        ...
        <Paper elevation={2} sx={{ p: 3, mb: 4 }}>
          ...
          <Grid container spacing={2}>
            <Grid item size={12}>
              <TextField
                fullWidth
                label="Número Connect Group"
                name="ikor_number"
                value={formData.ikor_number}
      ...
      <Dialog open={openDialog} onClose={handleCloseDialog}>
        ...
        <DialogActions>
          ...
          <Button onClick={handleDeletePart} color="error">
            Eliminar
          </Button>
        </DialogActions>
      </Dialog>
