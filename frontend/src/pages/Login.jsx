  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      setSnackbar({
        open: true,
        message:
          error.response?.data?.detail || "Error al actualizar contraseña",
        severity: "error",
      });
    }
  };
    ...
    <Container maxWidth="xs">
      <header>
        <img
          ...
          style={{ width: "150px", position: "absolute", top: 8, left: 12 }}
        />
      </header>
      ...
      >
        ...
        >
          ...
          <DialogContent>
            <DialogContentText>
              Para registrate al portal es necesario que ingreses todos tus
              datos, ya que son mandatorios para su alta al sistema.
            </DialogContentText>
